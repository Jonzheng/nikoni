...
<div id="x-content">
    ...
    <div class="x-wiki-info">
    	<span>阅读: 688413044</span>
    	
<a href="#" target="#" class="x-can-edit uk-text-danger">编辑</a></div>
...
a = <span class="string">"ABC"</span>; <span class="comment">// 错误：不能把字符串赋给整型变量</span>
</code></pre>
...
<p><img src="/static/img/loading.svg" data-src="/files/attachments/923791878255456/0" alt="py-var-code-1"></p>
<p>执行<code>b = a</code>，解释器创建了变量<code>b</code>，并把<code>b</code>指向<code>a</code>指向的字符串<code>'ABC'</code>：</p>
<p><img src="/static/img/loading.svg" data-src="/files/attachments/923792058613440/0" alt="py-var-code-2"></p>
<p>执行<code>a = 'XYZ'</code>，解释器创建了字符串'XYZ'，并把<code>a</code>的指向改为<code>'XYZ'</code>，但<code>b</code>并没有更改：</p>
<p><img src="/static/img/loading.svg" data-src="/files/attachments/923792191637760/0" alt="py-var-code-3"></p>
...
</div><h3></h3><p></p><h3></h3><p>
</p>

    <hr>
    <div class="x-wiki-prev-next uk-clearfix" style="padding-left: 15px; padding-right: 15px;">
</div><hr>

    <div class="x-anchor x-comment-anchor">
