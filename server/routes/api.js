...
const { queryComment, saveComment, deleteComment, queryChat, saveChat, deleteMessage } = require('../service/comment')
...
router.post('/queryChat', queryChat)
router.post('/saveChat', checkContent, saveChat)
